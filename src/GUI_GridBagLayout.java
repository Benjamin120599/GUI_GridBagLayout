...
public class GUI_GridBagLayout extends JFrame {
	...
	public void crearComponentes() {
		...
		metodoGeneral(checkBox4, 0, 13, 1, 1, 1);
		...
		metodoGeneral(checkBox5, 0, 14, 1, 1, 1);
		...
		metodoGeneral(checkBox6, 0, 15, 1, 1, 1);
		...
		metodoPanel1(label11, 0, 0, 1, 1, 1);
		...
		try {
			...
			metodoPanel1(cajaEmail, 0, 2, 1, 1, 1);
		...
		metodoPanel1(label12, 0, 3, 1, 1, 1);
		
		JTextField textField5 = new JTextField();
		metodoPanel1(textField5, 0, 4, 1, 1, 1);
		
		JLabel label13 = new JLabel("Last Name.");
		label13.setFont(Titulo);
		metodoPanel1(label13, 0, 5, 1, 1, 1);
		
		JTextField textField6 = new JTextField();
		metodoPanel1(textField6, 0, 6, 1, 1, 1);
